...
app.factory('Post', function ($firebase, FIREBASE_URL, User, $rootScope) {
	...
	$rootScope.editAccess = function(postOwner, currentUser, signedIn){
		var usersMatch = postOwner === currentUser;

		return usersMatch && signedIn;
	};
